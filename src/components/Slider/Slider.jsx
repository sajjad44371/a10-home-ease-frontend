      ...
      >
        <SwiperSlide>
          ...
          >
            ...
            <div className="hero-content text-neutral-content text-center py-[50px] md:py-[80px] lg:py-[50px]">
              <div className="max-w-xl lg:max-w-2xl">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-[40px] md:leading-[50px] lg:leading-[60px] text-[#fafafa]">
                ...
                <button className="btn rounded-lg btn-primary duration-200 text-[#fafafa]">
                  Explore Now
                </button>
              </div>
            </div>
